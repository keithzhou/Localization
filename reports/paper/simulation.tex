...
In fig~\ref{fig:sim_hm_3_line}, three microphones are placed $10$ cm apart from each other on the x-axis. Error heatmap shows high uncertainty on the x axis, and the overall accuracy much worse than that with three microphones placed in a triangle. The average error is $55.05$ cm. 
