...
2a = P M_1 - P M_2 
\]
then the TDOA is $2a/340$ seconds. Assuming a sampling rate of $34$ KHz, fig~\ref{fig:sim_2_5} shows the region $R$ where all points have TDOA close to $2a/340$ s within one sample difference:
\[
R=\{\hat P: |(\hat P M_1 - \hat P M_2) - 2a|< \frac{1}{2} \mbox{ samples}\}
\]
